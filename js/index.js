...
//		模块三
		var blessing = [
			...
			'May you be single next year',
			'The rest of the day went smoothly and made money',
			'Keep it up this year, too',
			'I hope you wont lose so much hair this year',
			'Good health and live to be 99',
		];
		vartexts = $("<span></span>");
